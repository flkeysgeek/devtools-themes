 ...
 ******************************************************************************/
    ...
    _.extend(AvastWRC,
         ...
         */
            ...
            // save it to local storage
                if (this.browserVersion === 0) this.browserVersion = this.getBrowserVersion();
                if (AvastWRC.Utils.getBrowserInfo().isFirefox() && this.browserVersion < 48 || typeof localStorage == "undefined") {
                    AvastWRC.bs.getLocalStorage().setItem(storage, data);
                }
                else {
    ...
    AvastWRC.UrlInfo.prototype = {
        ...
        */
        getRatingCategory: function () {
            ...
            if (this.getPhishing() > 1 || this.getBlocker() > 0 || (this.getRatingLevel() == 0 && this.getPhishingDomain() > 1))
                return RATING_BAD;
            else {
    ...
    AvastWRC.Cache = {
        ...
        load : function(){
            ...
            this.storage = AvastWRC.getStorage(AvastWRC.DEFAULTS.CACHE.DOMAIN);
